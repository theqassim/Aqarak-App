        document.addEventListener('DOMContentLoaded', async () => {
            ...
            try {
                ...
                properties.forEach(prop => {
                    ...
                    let statusHtml = '', link = '#', clickAction = '';
                ...
                spinner.style.display = 'none';
                container.innerHTML = '<p style="text-align:center; color:#ff4444;">حدث خطأ في الاتصال.</p>';
            }
        });