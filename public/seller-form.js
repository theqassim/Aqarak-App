// 🇪🇬 بيانات المحافظات والمدن الكاملة
const egyptLocations = {
    "القاهرة": ["التجمع الخامس", "مدينة نصر", "المعادي", "مصر الجديدة", "الشروق", "مدينتي", "الرحاب", "العاصمة الإدارية", "المقطم", "الزيتون", "عين شمس", "شبرا", "حلوان", "المرج", "وسط البلد", "جاردن سيتي", "الزمالك", "المنيل", "حدائق القبة", "العباسية", "المطرية", "السيدة زينب", "الوايلي", "باب الشعرية", "مصر القديمة", "عابدين", "الموسكي", "الأزبكية", "الجمالية", "بولاق", "النزهة", "السلام", "البساتين", "دار السلام", "طره", "15 مايو", "التبين", "بدر"],
    "الجيزة": ["6 أكتوبر", "الشيخ زايد", "الهرم", "فيصل", "الدقي", "المهندسين", "العجوزة", "إمبابة", "حدائق الأهرام", "الوراق", "بولاق الدكرور", "المنيب", "البدرشين", "العياط", "الصف", "أطفيح", "كرداسة", "أوسيم", "الحوامدية", "أبو النمرس", "منشأة القناطر", "الواحات البحرية"],
    "الإسكندرية": ["سموحة", "ميامي", "المنتزه", "العجمي", "سيدي بشر", "الإبراهيمية", "كامب شيزار", "الشاطبي", "محرم بك", "العصافرة", "المندرة", "سان ستيفانو", "جليم", "رشدي", "كفر عبده", "سيدي جابر", "الساحل الشمالي", "برج العرب", "البيطاش", "الهانوفيل", "العامرية", "الدخيلة", "المكس", "اللبان", "الجمرك", "المنشية", "العطارين", "كرموز"],
    "القليوبية": ["بنها", "شبرا الخيمة", "قليوب", "الخانكة", "القناطر الخيرية", "طوخ", "العبور", "كفر شكر", "شبين القناطر", "قها", "الخصوص"],
    "الدقهلية": ["المنصورة", "طلخا", "ميت غمر", "السنبلاوين", "دكرنس", "بلقاس", "اجا", "شربين", "منية النصر", "المنزلة", "المطرية", "الجمالية", "نبروه", "تمى الأمديد", "بني عبيد", "ميت سلسيل", "محلة دمنة"],
    "الشرقية": ["الزقازيق", "العاشر من رمضان", "منيا القمح", "بلبيس", "فاقوس", "أبو حماد", "ديرب نجم", "ههيا", "أبو كبير", "كفر صقر", "أولاد صقر", "مشتول السوق", "الإبراهيمية", "الحسينية", "صان الحجر", "القنايات", "القرين"],
    "الغربية": ["طنطا", "المحلة الكبرى", "كفر الزيات", "زفتى", "السنطة", "بسيون", "قطور", "سمنود"],
    "المنوفية": ["شبين الكوم", "مدينة السادات", "منوف", "أشمون", "قويسنا", "تلا", "الباجور", "الشهداء", "بركة السبع", "سرس الليان"],
    "البحيرة": ["دمنهور", "كفر الدوار", "إيتاي البارود", "أبو حمص", "رشيد", "كوم حمادة", "وادي النطرون", "أبو المطامير", "الدلنجات", "حوش عيسى", "المحمودية", "الرحمانية", "شبراخيت", "ادكو", "النوبارية الجديدة"],
    "دمياط": ["دمياط", "رأس البر", "دمياط الجديدة", "فارسكور", "الزرقا", "كفر سعد", "السرو", "الروضة", "ميت أبو غالب", "عزبة البرج"],
    "بورسعيد": ["بورسعيد", "بورفؤاد", "حي الشرق", "حي العرب", "حي المناخ", "حي الضواحي", "حي الجنوب", "حي الزهور"],
    "الاسماعيلية": ["الاسماعيلية", "التل الكبير", "فايد", "القنطرة شرق", "القنطرة غرب", "أبو صوير", "القصاصين"],
    "السويس": ["السويس", "الأربعين", "عتاقة", "الجناين", "فيصل"],
    "كفر الشيخ": ["كفر الشيخ", "دسوق", "فوه", "مطوبس", "بلطيم", "سيدي سالم", "بيلا", "الحامول", "قلين", "الرياض", "برج البرلس"],
    "الفيوم": ["الفيوم", "سنورس", "إطسا", "طامية", "أبشواي", "يوسف الصديق"],
    "بني سويف": ["بني سويف", "الواسطى", "ناصر", "اهناسيا", "ببا", "الفشن", "سمسطا"],
    "المنيا": ["المنيا", "ملوي", "مغاغة", "بني مزار", "سمالوط", "أبو قرقاص", "ديرمواس", "العدوة", "مطاي"],
    "أسيوط": ["أسيوط", "ديروط", "القوصية", "أبنوب", "منفلوط", "أبو تيج", "الغنايم", "ساحل سليم", "البداري", "صدفا", "الفتح"],
    "سوهاج": ["سوهاج", "جرجا", "طمه", "طهطا", "المراغة", "البلينا", "المنشأة", "أخميم", "ساقلتة", "دار السلام", "جهينة"],
    "قنا": ["قنا", "نجع حمادي", "دشنا", "قوص", "فرشوط", "قفط", "نقادة", "الوقف", "أبو تشت"],
    "الأقصر": ["الأقصر", "إسنا", "أرمنت", "القرنة", "طيبة", "الزينية", "البياضية"],
    "أسوان": ["أسوان", "كوم أمبو", "إدفو", "نصر النوبة", "دراو", "أبو سمبل"],
    "البحر الأحمر": ["الغردقة", "الجونة", "سفاجا", "القصير", "مرسى علم", "رأس غارب", "حلايب", "شلاتين"],
    "جنوب سيناء": ["شرم الشيخ", "دهب", "نويبع", "طابا", "طور سيناء", "سانت كاترين", "رأس سدر", "أبو رديس", "أبو زنيمة"],
    "مطروح": ["مرسى مطروح", "العلمين", "مارينا", "الضبعة", "سيوة", "الحمام", "النجيلة", "السلوم", "براني"],
...
// دالة تشغيل قوائم المحافظات والمدن
function initLocationSelects() {
    ...
    // 2. تحديث المدن عند تغيير المحافظة
    govSelect.addEventListener('change', function() {
        const selectedGov = this.value;
        citySelect.innerHTML = '<option value="">اختر المدينة...</option>'; // مسح المدن القديمة
...
// دالة التحكم في الحقول حسب نوع العقار
function toggleFields() {
    ...
    const groups = {
        ...
        buildingDetails: document.getElementById('building-details-group'), // تفاصيل العمارة (أدوار ووحدات)
        rooms: document.getElementById('rooms-group'),            // غرف وحمامات
        finish: document.getElementById('finishing-group'),       // تشطيب
    ...
    switch (category) {
        ...
        case 'office':      // مكتب
            ...
            if(groups.rooms) groups.rooms.style.display = 'flex'; // استخدام Flex أو Grid
        ...
        case 'building':    // عمارة بالكامل
            if(groups.buildingDetails) groups.buildingDetails.style.display = 'flex'; // إظهار أدوار ووحدات
            if(groups.finish) groups.finish.style.display = 'block'; // حالة تشطيب العمارة
            break;

        case 'land':        // أرض
            if(groups.landType) groups.landType.style.display = 'block';
            // الأرض مش محتاجة غرف ولا حمامات ولا تشطيب
            break;
